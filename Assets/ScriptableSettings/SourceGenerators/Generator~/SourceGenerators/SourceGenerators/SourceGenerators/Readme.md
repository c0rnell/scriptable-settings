...
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [SourceGenerators.Sample.csproj](../SourceGenerators.Sample/SourceGenerators.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
